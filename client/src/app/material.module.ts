...
import {MatNativeDateModule,
  ...
  MatCheckboxModule, MatToolbarModule, MatCard, MatCardModule,
...
@NgModule({
  imports: [MatTabsModule, MatDividerModule, MatSliderModule,
    ...
    MatToolbarModule, MatCardModule, MatFormFieldModule, MatProgressSpinnerModule, MatInputModule, MatPaginatorModule],
